...
class PackagingTests(unittest.TestCase):
    ...
    def test_wheel_includes_bundled_remote_script(self):
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            self.assertIn("livemcp/max_bridge/README.md", wheel_files)
            self.assertIn("livemcp/max_bridge/device_bridge.js", wheel_files)
            self.assertIn("livemcp/max_bridge/device_server.js", wheel_files)
            self.assertIn("livemcp/max_bridge/schema.json", wheel_files)
